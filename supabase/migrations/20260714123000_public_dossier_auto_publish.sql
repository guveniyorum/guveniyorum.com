-- Publish central complaint dossiers and linked evidence for normal visitors.
-- Evidence stays in the private bucket and is exposed only through short-lived signed URLs.
